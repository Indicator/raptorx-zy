# 
# $Id: targets.mak.in,v 1.1.18.1 2007-03-25 22:02:49 oliver Exp $
#
# Author:
#   Oliver Kohlbacher
#
...
collectlib:	default
	...
	@for i in $(OBJECTS); do echo $(DIRECTORY)/$$i >>/home/zywang/work/allbio/contrib/BALL/source/$(THISLIB).objects ; done
