...
#line 74 "smilesParserParser.y"
    { new SmilesParser::SPBond((yyvsp[(1) - (3)].atom), (yyvsp[(3) - (3)].atom), (yyvsp[(2) - (3)].number)); (yyval.atom) = (yyvsp[(1) - (3)].atom); }
    break;

  case 5:
#line 75 "smilesParserParser.y"
    { new SmilesParser::SPBond((yyvsp[(1) - (2)].atom), (yyvsp[(2) - (2)].atom)); (yyval.atom) = (yyvsp[(1) - (2)].atom); }
    break;
...
#line 80 "smilesParserParser.y"
    { new SmilesParser::SPBond((yyvsp[(3) - (4)].atom), (yyvsp[(1) - (4)].atom), 1); (yyval.atom) = (yyvsp[(1) - (4)].atom); }
    break;

  case 8:
#line 81 "smilesParserParser.y"
    { new SmilesParser::SPBond((yyvsp[(4) - (5)].atom), (yyvsp[(1) - (5)].atom), (yyvsp[(3) - (5)].number)); (yyval.atom) = (yyvsp[(1) - (5)].atom); }
    break;
...
#line 86 "smilesParserParser.y"
    {
			...
			if ((yyvsp[(2) - (2)].conns) != 0) 
			{ 
				SmilesParser::state.current_parser->createBonds((yyvsp[(1) - (2)].atom), (yyvsp[(2) - (2)].conns)); 
			} 
		}
    break;
...
#line 94 "smilesParserParser.y"
    { 
			(yyvsp[(3) - (8)].atom)->setFormalCharge((yyvsp[(6) - (8)].number)); 
			(yyvsp[(3) - (8)].atom)->setIsotope((yyvsp[(2) - (8)].number));
			(yyvsp[(3) - (8)].atom)->setInBrackets(true);
			if ((yyvsp[(5) - (8)].number) != 0)
			{
				for (int i = 0; i < (yyvsp[(5) - (8)].number); i++)
				{
					new SmilesParser::SPBond(SmilesParser::state.current_parser->createAtom("H"), (yyvsp[(3) - (8)].atom));
				}
			}
			if ((yyvsp[(4) - (8)].chiral) != 0)
			{	
				(yyvsp[(3) - (8)].atom)->setChirality(*(yyvsp[(4) - (8)].chiral));
				delete (yyvsp[(4) - (8)].chiral);
			}
			if ((yyvsp[(8) - (8)].conns) != 0) 
			{ 
				SmilesParser::state.current_parser->createBonds((yyvsp[(3) - (8)].atom), (yyvsp[(8) - (8)].conns)); 
				delete  (yyvsp[(8) - (8)].conns);
			} 
			(yyval.atom) = (yyvsp[(3) - (8)].atom); 
		}
    break;
...
#line 118 "smilesParserParser.y"
    { 
			...
			(yyval.atom)->setFormalCharge((yyvsp[(4) - (5)].number)); 
			(yyval.atom)->setIsotope((yyvsp[(2) - (5)].number));
...
#line 185 "smilesParserParser.y"
    {
			...
			(yyval.conns)->push_back((yyvsp[(1) - (1)].number));
		}
    break;
...
#line 190 "smilesParserParser.y"
    {
			(yyval.conns) = (yyvsp[(1) - (2)].conns);
			(yyval.conns)->push_back((yyvsp[(2) - (2)].number));
		}
    break;
...
#line 228 "smilesParserParser.y"
    {
			(yyval.chiral) = new SmilesParser::ChiralDef(SmilesParser::TH, (yyvsp[(2) - (2)].number)); 
		}
    break;
...
#line 232 "smilesParserParser.y"
    {
			(yyval.chiral) = new SmilesParser::ChiralDef(SmilesParser::AL, (yyvsp[(2) - (2)].number)); 
		}
    break;
...
#line 236 "smilesParserParser.y"
    {
			(yyval.chiral) = new SmilesParser::ChiralDef(SmilesParser::TB, (yyvsp[(2) - (2)].number)); 
		}
    break;
...
#line 244 "smilesParserParser.y"
    {
			(yyval.chiral) = new SmilesParser::ChiralDef(SmilesParser::OH, (yyvsp[(2) - (2)].number)); 
		}
    break;
