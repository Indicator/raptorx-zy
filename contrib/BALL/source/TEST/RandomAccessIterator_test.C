...
// vi: set ts=2:
//
// $Id: RandomAccessIterator_test.C,v 1.14.30.1 2007-03-25 21:48:49 oliver Exp $
//
...
START_TEST(RandomAccessIterator, "$Id: RandomAccessIterator_test.C,v 1.14.30.1 2007-03-25 21:48:49 oliver Exp $")
