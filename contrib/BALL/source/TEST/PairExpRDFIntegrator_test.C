...
// vi: set ts=2:
//
// $Id: PairExpRDFIntegrator_test.C,v 1.11.32.1 2007-03-25 21:47:28 oliver Exp $
...
START_TEST(PairExpRDFIntegrator, "$Id: PairExpRDFIntegrator_test.C,v 1.11.32.1 2007-03-25 21:47:28 oliver Exp $")
