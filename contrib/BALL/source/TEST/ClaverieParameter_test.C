...
// vi: set ts=2:
//
// $Id: ClaverieParameter_test.C,v 1.8.30.1 2007-03-25 21:46:54 oliver Exp $
...
START_TEST(ClaverieParameter, "$Id: ClaverieParameter_test.C,v 1.8.30.1 2007-03-25 21:46:54 oliver Exp $")
