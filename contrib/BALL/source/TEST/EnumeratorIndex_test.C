...
// vi: set ts=2:
//
// $Id: EnumeratorIndex_test.C,v 1.1.32.1 2007-03-25 21:47:04 oliver Exp $
...
START_TEST(Enumerator, "$Id: EnumeratorIndex_test.C,v 1.1.32.1 2007-03-25 21:47:04 oliver Exp $")
