...
// vi: set ts=2:
//
// $Id: MolmecSupport_test.C,v 1.6.28.1 2007-03-25 21:47:22 oliver Exp $
...
START_TEST(class_name, "$Id: MolmecSupport_test.C,v 1.6.28.1 2007-03-25 21:47:22 oliver Exp $")
