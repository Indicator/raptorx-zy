...
public:
	...
	IloPlugInManager* getPlugInManager() const { return _plugins; }
	...
	IloBool mustRemove(IloInt id) const {
		return ((id == -1) || (_ids->getExtractable(id) == (IloExtractableI*)-1));
	}
	...
	void removeFromAllAndDestroy(const IloExtractableArray, IloBool inDelete);
...
public:
	...
	IloNumArray(IloArrayI* i=0) : IloNumArrayBase(i) {}
