...
CPXLIBAPI
CPXLPptr CPXPUBLIC
   CPXLcreateprob (CPXCENVptr env, int *status_p, const char *probname_str);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLcopylpwnames (CPXCENVptr env, CPXLPptr lp, CPXINT numcols, CPXINT numrows, int objsense, const double *objective, const double *rhs, const char *sense, const CPXLONG *matbeg, const CPXINT *matcnt, const CPXINT *matind, const double *matval, const double *lb, const double *ub, const double *rngval, char const *const *colname, char const *const *rowname);

CPXLIBAPI
int CPXPUBLIC
   CPXLcopylp (CPXCENVptr env, CPXLPptr lp, CPXINT numcols, CPXINT numrows, int objsense, const double *objective, const double *rhs, const char *sense, const CPXLONG *matbeg, const CPXINT *matcnt, const CPXINT *matind, const double *matval, const double *lb, const double *ub, const double *rngval);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLpivot (CPXCENVptr env, CPXLPptr lp, int jenter, int jleave, int leavestat);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetx (CPXCENVptr env, CPXCLPptr lp, double *x, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetax (CPXCENVptr env, CPXCLPptr lp, double *x, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetpi (CPXCENVptr env, CPXCLPptr lp, double *pi, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetslack (CPXCENVptr env, CPXCLPptr lp, double *slack, CPXINT begin, CPXINT end);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetcolinfeas (CPXCENVptr env, CPXCLPptr lp, const double *x, double *infeasout, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetdj (CPXCENVptr env, CPXCLPptr lp, double *dj, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetgrad (CPXCENVptr env, CPXCLPptr lp, CPXINT j, CPXINT *head, double *y);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetconflict (CPXCENVptr env, CPXCLPptr lp, int *confstat_p, CPXINT *rowind, int *rowbdstat, CPXINT *confnumrows_p, CPXINT *colind, int *colbdstat, CPXINT *confnumcols_p);

CPXLIBAPI
int CPXPUBLIC
   CPXLrefineconflictext (CPXCENVptr env, CPXLPptr lp, CPXLONG grpcnt, CPXLONG concnt, const double *grppref, const CPXLONG *grpbeg, const CPXINT *grpind, const char *grptype);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLfeasoptext (CPXCENVptr env, CPXLPptr lp, CPXINT grpcnt, CPXLONG concnt, const double *grppref, const CPXLONG *grpbeg, const CPXINT *grpind, const char *grptype);

CPXLIBAPI
int CPXPUBLIC
   CPXLnewrows (CPXCENVptr env, CPXLPptr lp, CPXINT rcnt, const double *rhs, const char *sense, const double *rngval, char const *const *rowname);

CPXLIBAPI
int CPXPUBLIC
   CPXLaddrows (CPXCENVptr env, CPXLPptr lp, CPXINT ccnt, CPXINT rcnt, CPXLONG nzcnt, const double *rhs, const char *sense, const CPXLONG *rmatbeg, const CPXINT *rmatind, const double *rmatval, char const *const *colname, char const *const *rowname);

CPXLIBAPI
int CPXPUBLIC
   CPXLnewcols (CPXCENVptr env, CPXLPptr lp, CPXINT ccnt, const double *obj, const double *lb, const double *ub, const char *xctype, char const *const *colname);

CPXLIBAPI
int CPXPUBLIC
   CPXLaddcols (CPXCENVptr env, CPXLPptr lp, CPXINT ccnt, CPXLONG nzcnt, const double *obj, const CPXLONG *cmatbeg, const CPXINT *cmatind, const double *cmatval, const double *lb, const double *ub, char const *const *colname);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLchgname (CPXCENVptr env, CPXLPptr lp, int key, CPXINT ij, const char *newname_str);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLchgbds (CPXCENVptr env, CPXLPptr lp, CPXINT cnt, const CPXINT *indices, const char *lu, const double *bd);

CPXLIBAPI
int CPXPUBLIC
   CPXLchgobj (CPXCENVptr env, CPXLPptr lp, CPXINT cnt, const CPXINT *indices, const double *values);

CPXLIBAPI
int CPXPUBLIC
   CPXLchgrhs (CPXCENVptr env, CPXLPptr lp, CPXINT cnt, const CPXINT *indices, const double *values);

CPXLIBAPI
int CPXPUBLIC
   CPXLchgrngval (CPXCENVptr env, CPXLPptr lp, CPXINT cnt, const CPXINT *indices, const double *values);

CPXLIBAPI
int CPXPUBLIC
   CPXLchgsense (CPXCENVptr env, CPXLPptr lp, CPXINT cnt, const CPXINT *indices, const char *sense);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLpreaddrows (CPXCENVptr env, CPXLPptr lp, CPXINT rcnt, CPXLONG nzcnt, const double *rhs, const char *sense, const CPXLONG *rmatbeg, const CPXINT *rmatind, const double *rmatval, char const *const *rowname);

CPXLIBAPI
int CPXPUBLIC
   CPXLprechgobj (CPXCENVptr env, CPXLPptr lp, CPXINT cnt, const CPXINT *indices, const double *values);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetobj (CPXCENVptr env, CPXCLPptr lp, double *obj, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetrhs (CPXCENVptr env, CPXCLPptr lp, double *rhs, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetsense (CPXCENVptr env, CPXCLPptr lp, char *sense, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetcols (CPXCENVptr env, CPXCLPptr lp, CPXLONG *nzcnt_p, CPXLONG *cmatbeg, CPXINT *cmatind, double *cmatval, CPXLONG cmatspace, CPXLONG *surplus_p, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetrows (CPXCENVptr env, CPXCLPptr lp, CPXLONG *nzcnt_p, CPXLONG *rmatbeg, CPXINT *rmatind, double *rmatval, CPXLONG rmatspace, CPXLONG *surplus_p, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetlb (CPXCENVptr env, CPXCLPptr lp, double *lb, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetub (CPXCENVptr env, CPXCLPptr lp, double *ub, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetrngval (CPXCENVptr env, CPXCLPptr lp, double *rngval, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetprobname (CPXCENVptr env, CPXCLPptr lp, char *buf_str, CPXSIZE bufspace, CPXSIZE *surplus_p);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetobjname (CPXCENVptr env, CPXCLPptr lp, char *buf_str, CPXSIZE bufspace, CPXSIZE *surplus_p);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetcolname (CPXCENVptr env, CPXCLPptr lp, char **name, char *namestore, CPXSIZE storespace, CPXSIZE *surplus_p, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetrowname (CPXCENVptr env, CPXCLPptr lp, char **name, char *namestore, CPXSIZE storespace, CPXSIZE *surplus_p, CPXINT begin, CPXINT end);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLtuneparam (CPXENVptr env, CPXLPptr lp, int intcnt, const int *intnum, const CPXINT *intval, int dblcnt, const int *dblnum, const double *dblval, int strcnt, const int *strnum, char const *const *strval, int *tunestat_p);

CPXLIBAPI
int CPXPUBLIC
   CPXLtuneparamprobset (CPXENVptr env, int filecnt, char const *const *filename, char const *const *filetype, int intcnt, const int *intnum, const CPXINT *intval, int dblcnt, const int *dblnum, const double *dblval, int strcnt, const int *strnum, char const *const *strval, int *tunestat_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLmdleave (CPXCENVptr env, CPXLPptr lp, const CPXINT *indices, CPXINT cnt, double *downratio, double *upratio);

CPXLIBAPI
int CPXPUBLIC
   CPXLstrongbranch (CPXCENVptr env, CPXLPptr lp, const CPXINT *indices, CPXINT cnt, double *downobj, double *upobj, CPXLONG itlim);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLcopypartialbase (CPXCENVptr env, CPXLPptr lp, CPXINT rcnt, const CPXINT *rindices, const int *rstat, CPXINT ccnt, const CPXINT *cindices, const int *cstat);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLtightenbds (CPXCENVptr env, CPXLPptr lp, CPXINT cnt, const CPXINT *indices, const char *lu, const double *bd);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLuncrushform (CPXCENVptr env, CPXCLPptr lp, CPXINT plen, const CPXINT *pind, const double *pval, CPXINT *len_p, double *offset_p, CPXINT *ind, double *val);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLcopyprotected (CPXCENVptr env, CPXLPptr lp, CPXINT cnt, const CPXINT *indices);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetprotected (CPXCENVptr env, CPXCLPptr lp, CPXINT *cnt_p, CPXINT *indices, CPXINT pspace, CPXINT *surplus_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLcopyorder (CPXCENVptr env, CPXLPptr lp, CPXINT cnt, const CPXINT *indices, const CPXINT *priority, const int *direction);

CPXLIBAPI
int CPXPUBLIC
   CPXLcopysos (CPXCENVptr env, CPXLPptr lp, CPXINT numsos, CPXLONG numsosnz, const char *sostype, const CPXLONG *sosbeg, const CPXINT *sosind, const double *soswt, char const *const *sosname);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetnumcuts (CPXCENVptr env, CPXCLPptr lp, int cuttype, CPXINT *num_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetmipstartindex (CPXCENVptr env, CPXCLPptr lp, const char *lname_str, int *index_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLchgctype (CPXCENVptr env, CPXLPptr lp, CPXINT cnt, const CPXINT *indices, const char *xctype);

CPXLIBAPI
int CPXPUBLIC
   CPXLaddsos (CPXCENVptr env, CPXLPptr lp, CPXINT numsos, CPXLONG numsosnz, const char *sostype, const CPXLONG *sosbeg, const CPXINT *sosind, const double *soswt, char const *const *sosname);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetsos (CPXCENVptr env, CPXCLPptr lp, CPXLONG *numsosnz_p, char *sostype, CPXLONG *sosbeg, CPXINT *sosind, double *soswt, CPXLONG sosspace, CPXLONG *surplus_p, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetsosname (CPXCENVptr env, CPXCLPptr lp, char **name, char *namestore, CPXSIZE storespace, CPXSIZE *surplus_p, CPXINT begin, CPXINT end);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetsosinfeas (CPXCENVptr env, CPXCLPptr lp, const double *x, double *infeasout, CPXINT begin, CPXINT end);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetindconstr (CPXCENVptr env, CPXCLPptr lp, CPXINT *indvar_p, int *complemented_p, CPXINT *nzcnt_p, double *rhs_p, char *sense_p, CPXINT *linind, double *linval, CPXINT space, CPXINT *surplus_p, CPXINT which);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetindconstrindex (CPXCENVptr env, CPXCLPptr lp, const char *lname_str, CPXINT *index_p);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetindconstrname (CPXCENVptr env, CPXCLPptr lp, char *buf_str, CPXSIZE bufspace, CPXSIZE *surplus_p, CPXINT which);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetindconstrinfeas (CPXCENVptr env, CPXCLPptr lp, const double *x, double *infeasout, CPXINT begin, CPXINT end);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetorder (CPXCENVptr env, CPXCLPptr lp, CPXINT *cnt_p, CPXINT *indices, CPXINT *priority, int *direction, CPXINT ordspace, CPXINT *surplus_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLaddsolnpooldivfilter (CPXCENVptr env, CPXLPptr lp, double lower_bound, double upper_bound, CPXINT nzcnt, const CPXINT *ind, const double *weight, const double *refval, const char *lname_str);

CPXLIBAPI
int CPXPUBLIC
   CPXLaddsolnpoolrngfilter (CPXCENVptr env, CPXLPptr lp, double lb, double ub, CPXINT nzcnt, const CPXINT *ind, const double *val, const char *lname_str);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetsolnpooldivfilter (CPXCENVptr env, CPXCLPptr lp, double *lower_cutoff_p, double *upper_cutoff_p, CPXINT *nzcnt_p, CPXINT *ind, double *val, double *refval, CPXINT space, CPXINT *surplus_p, int which);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetsolnpoolrngfilter (CPXCENVptr env, CPXCLPptr lp, double *lb_p, double *ub_p, CPXINT *nzcnt_p, CPXINT *ind, double *val, CPXINT space, CPXINT *surplus_p, int which);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetsolnpoolfiltername (CPXCENVptr env, CPXCLPptr lp, char *buf_str, CPXSIZE bufspace, CPXSIZE *surplus_p, int which);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetsolnpoolslack (CPXCENVptr env, CPXCLPptr lp, int soln, double *slack, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetsolnpoolqconstrslack (CPXCENVptr env, CPXCLPptr lp, int soln, double *qcslack, CPXINT begin, CPXINT end);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetcallbacknodeinfo (CPXCENVptr env, void *cbdata, int wherefrom, CPXLONG nodeindex, int whichinfo, void *result_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLbranchcallbackbranchbds (CPXCENVptr env, void *cbdata, int wherefrom, double nodeest, CPXINT cnt, const CPXINT *indices, const char *lu, const int *bd, void *userhandle, CPXLONG *seqnum_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetcallbackorder (CPXCENVptr env, void *cbdata, int wherefrom, CPXINT *priority, int *direction, CPXINT begin, CPXINT end);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetcallbackgloballb (CPXCENVptr env, void *cbdata, int wherefrom, double *lb, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetcallbackglobalub (CPXCENVptr env, void *cbdata, int wherefrom, double *ub, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetcallbacknodelb (CPXCENVptr env, void *cbdata, int wherefrom, double *lb, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetcallbacknodeub (CPXCENVptr env, void *cbdata, int wherefrom, double *ub, CPXINT begin, CPXINT end);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLaddusercuts (CPXCENVptr env, CPXLPptr lp, CPXINT rcnt, CPXLONG nzcnt, const double *rhs, const char *sense, const CPXLONG *rmatbeg, const CPXINT *rmatind, const double *rmatval, char const *const *rowname);

CPXLIBAPI
int CPXPUBLIC
   CPXLaddlazyconstraints (CPXCENVptr env, CPXLPptr lp, CPXINT rcnt, CPXLONG nzcnt, const double *rhs, const char *sense, const CPXLONG *rmatbeg, const CPXINT *rmatind, const double *rmatval, char const *const *rowname);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLNETaddnodes (CPXCENVptr env, CPXNETptr net, CPXINT nnodes, const double *supply, char const *const *name);

CPXLIBAPI
int CPXPUBLIC
   CPXLNETaddarcs (CPXCENVptr env, CPXNETptr net, CPXINT narcs, const CPXINT *fromnode, const CPXINT *tonode, const double *low, const double *up, const double *obj, char const *const *anames);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLNETchgname (CPXCENVptr env, CPXNETptr net, int key, CPXINT vindex, const char *name_str);

CPXLIBAPI
int CPXPUBLIC
   CPXLNETchgarcname (CPXCENVptr env, CPXNETptr net, CPXINT cnt, const CPXINT *indices, char const *const *newname);

CPXLIBAPI
int CPXPUBLIC
   CPXLNETchgnodename (CPXCENVptr env, CPXNETptr net, CPXINT cnt, const CPXINT *indices, char const *const *newname);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLNETgetnodename (CPXCENVptr env, CPXCNETptr net, char **nnames, char *namestore, CPXSIZE namespc, CPXSIZE *surplus_p, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXLNETgetarcname (CPXCENVptr env, CPXCNETptr net, char **nnames, char *namestore, CPXSIZE namespc, CPXSIZE *surplus_p, CPXINT begin, CPXINT end);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetqpcoef (CPXCENVptr env, CPXCLPptr lp, CPXINT rownum, CPXINT colnum, double *coef_p);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetquad (CPXCENVptr env, CPXCLPptr lp, CPXLONG *nzcnt_p, CPXLONG *qmatbeg, CPXINT *qmatind, double *qmatval, CPXLONG qmatspace, CPXLONG *surplus_p, CPXINT begin, CPXINT end);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLaddqconstr (CPXCENVptr env, CPXLPptr lp, CPXINT linnzcnt, CPXLONG quadnzcnt, double rhs, int sense, const CPXINT *linind, const double *linval, const CPXINT *quadrow, const CPXINT *quadcol, const double *quadval, const char *lname_str);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetqconstr (CPXCENVptr env, CPXCLPptr lp, CPXINT *linnzcnt_p, CPXLONG *quadnzcnt_p, double *rhs_p, char *sense_p, CPXINT *linind, double *linval, CPXINT linspace, CPXINT *linsurplus_p, CPXINT *quadrow, CPXINT *quadcol, double *quadval, CPXLONG quadspace, CPXLONG *quadsurplus_p, CPXINT which);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetqconstrname (CPXCENVptr env, CPXCLPptr lp, char *buf_str, CPXSIZE bufspace, CPXSIZE *surplus_p, CPXINT which);
...
CPXLIBAPI
int CPXPUBLIC
   CPXLgetqconstrinfeas (CPXCENVptr env, CPXCLPptr lp, const double *x, double *infeasout, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXLgetxqxax (CPXCENVptr env, CPXCLPptr lp, double *xqxax, CPXINT begin, CPXINT end);
