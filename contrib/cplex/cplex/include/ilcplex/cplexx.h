...
CPX_STATIC_INLINE CPXLPptr CPXPUBLIC
   CPXXcreateprob (CPXCENVptr env, int *status_p, const char *probname_str) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXcopylpwnames (CPXCENVptr env, CPXLPptr lp, CPXDIM numcols, CPXDIM numrows, int objsense, const double *objective, const double *rhs, const char *sense, const CPXNNZ *matbeg, const CPXDIM *matcnt, const CPXDIM *matind, const double *matval, const double *lb, const double *ub, const double *rngval, char const *const *colname, char const *const *rowname) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXcopylp (CPXCENVptr env, CPXLPptr lp, CPXDIM numcols, CPXDIM numrows, int objsense, const double *objective, const double *rhs, const char *sense, const CPXNNZ *matbeg, const CPXDIM *matcnt, const CPXDIM *matind, const double *matval, const double *lb, const double *ub, const double *rngval) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXpivot (CPXCENVptr env, CPXLPptr lp, int jenter, int jleave, int leavestat) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetx (CPXCENVptr env, CPXCLPptr lp, double *x, CPXDIM begin, CPXDIM end) {
      return CPX_CALL (getx) (env, lp, x, begin, end);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetax (CPXCENVptr env, CPXCLPptr lp, double *x, CPXDIM begin, CPXDIM end) {
      return CPX_CALL (getax) (env, lp, x, begin, end);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetpi (CPXCENVptr env, CPXCLPptr lp, double *pi, CPXDIM begin, CPXDIM end) {
      return CPX_CALL (getpi) (env, lp, pi, begin, end);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetslack (CPXCENVptr env, CPXCLPptr lp, double *slack, CPXDIM begin, CPXDIM end) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetcolinfeas (CPXCENVptr env, CPXCLPptr lp, const double *x, double *infeasout, CPXDIM begin, CPXDIM end) {
      return CPX_CALL (getcolinfeas) (env, lp, x, infeasout, begin, end);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetdj (CPXCENVptr env, CPXCLPptr lp, double *dj, CPXDIM begin, CPXDIM end) {
      return CPX_CALL (getdj) (env, lp, dj, begin, end);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetgrad (CPXCENVptr env, CPXCLPptr lp, CPXDIM j, CPXDIM *head, double *y) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetconflict (CPXCENVptr env, CPXCLPptr lp, int *confstat_p, CPXDIM *rowind, int *rowbdstat, CPXDIM *confnumrows_p, CPXDIM *colind, int *colbdstat, CPXDIM *confnumcols_p) {
      return CPX_CALL (getconflict) (env, lp, confstat_p, rowind, rowbdstat, confnumrows_p, colind, colbdstat, confnumcols_p);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXrefineconflictext (CPXCENVptr env, CPXLPptr lp, CPXNNZ grpcnt, CPXNNZ concnt, const double *grppref, const CPXNNZ *grpbeg, const CPXDIM *grpind, const char *grptype) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXfeasoptext (CPXCENVptr env, CPXLPptr lp, CPXDIM grpcnt, CPXNNZ concnt, const double *grppref, const CPXNNZ *grpbeg, const CPXDIM *grpind, const char *grptype) {
      return CPX_CALL (feasoptext) (env, lp, grpcnt, concnt, grppref, grpbeg, grpind, grptype);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXnewrows (CPXCENVptr env, CPXLPptr lp, CPXDIM rcnt, const double *rhs, const char *sense, const double *rngval, char const *const *rowname) {
      return CPX_CALL (newrows) (env, lp, rcnt, rhs, sense, rngval, rowname);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXaddrows (CPXCENVptr env, CPXLPptr lp, CPXDIM ccnt, CPXDIM rcnt, CPXNNZ nzcnt, const double *rhs, const char *sense, const CPXNNZ *rmatbeg, const CPXDIM *rmatind, const double *rmatval, char const *const *colname, char const *const *rowname) {
      return CPX_CALL (addrows) (env, lp, ccnt, rcnt, nzcnt, rhs, sense, rmatbeg, rmatind, rmatval, colname, rowname);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXnewcols (CPXCENVptr env, CPXLPptr lp, CPXDIM ccnt, const double *obj, const double *lb, const double *ub, const char *xctype, char const *const *colname) {
      return CPX_CALL (newcols) (env, lp, ccnt, obj, lb, ub, xctype, colname);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXaddcols (CPXCENVptr env, CPXLPptr lp, CPXDIM ccnt, CPXNNZ nzcnt, const double *obj, const CPXNNZ *cmatbeg, const CPXDIM *cmatind, const double *cmatval, const double *lb, const double *ub, char const *const *colname) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXchgname (CPXCENVptr env, CPXLPptr lp, int key, CPXDIM ij, const char *newname_str) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXchgbds (CPXCENVptr env, CPXLPptr lp, CPXDIM cnt, const CPXDIM *indices, const char *lu, const double *bd) {
      return CPX_CALL (chgbds) (env, lp, cnt, indices, lu, bd);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXchgobj (CPXCENVptr env, CPXLPptr lp, CPXDIM cnt, const CPXDIM *indices, const double *values) {
      return CPX_CALL (chgobj) (env, lp, cnt, indices, values);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXchgrhs (CPXCENVptr env, CPXLPptr lp, CPXDIM cnt, const CPXDIM *indices, const double *values) {
      return CPX_CALL (chgrhs) (env, lp, cnt, indices, values);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXchgrngval (CPXCENVptr env, CPXLPptr lp, CPXDIM cnt, const CPXDIM *indices, const double *values) {
      return CPX_CALL (chgrngval) (env, lp, cnt, indices, values);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXchgsense (CPXCENVptr env, CPXLPptr lp, CPXDIM cnt, const CPXDIM *indices, const char *sense) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXpreaddrows (CPXCENVptr env, CPXLPptr lp, CPXDIM rcnt, CPXNNZ nzcnt, const double *rhs, const char *sense, const CPXNNZ *rmatbeg, const CPXDIM *rmatind, const double *rmatval, char const *const *rowname) {
      return CPX_CALL (preaddrows) (env, lp, rcnt, nzcnt, rhs, sense, rmatbeg, rmatind, rmatval, rowname);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXprechgobj (CPXCENVptr env, CPXLPptr lp, CPXDIM cnt, const CPXDIM *indices, const double *values) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetobj (CPXCENVptr env, CPXCLPptr lp, double *obj, CPXDIM begin, CPXDIM end) {
      return CPX_CALL (getobj) (env, lp, obj, begin, end);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetrhs (CPXCENVptr env, CPXCLPptr lp, double *rhs, CPXDIM begin, CPXDIM end) {
      return CPX_CALL (getrhs) (env, lp, rhs, begin, end);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetsense (CPXCENVptr env, CPXCLPptr lp, char *sense, CPXDIM begin, CPXDIM end) {
      return CPX_CALL (getsense) (env, lp, sense, begin, end);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetcols (CPXCENVptr env, CPXCLPptr lp, CPXNNZ *nzcnt_p, CPXNNZ *cmatbeg, CPXDIM *cmatind, double *cmatval, CPXNNZ cmatspace, CPXNNZ *surplus_p, CPXDIM begin, CPXDIM end) {
      return CPX_CALL (getcols) (env, lp, nzcnt_p, cmatbeg, cmatind, cmatval, cmatspace, surplus_p, begin, end);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetrows (CPXCENVptr env, CPXCLPptr lp, CPXNNZ *nzcnt_p, CPXNNZ *rmatbeg, CPXDIM *rmatind, double *rmatval, CPXNNZ rmatspace, CPXNNZ *surplus_p, CPXDIM begin, CPXDIM end) {
      return CPX_CALL (getrows) (env, lp, nzcnt_p, rmatbeg, rmatind, rmatval, rmatspace, surplus_p, begin, end);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetlb (CPXCENVptr env, CPXCLPptr lp, double *lb, CPXDIM begin, CPXDIM end) {
      return CPX_CALL (getlb) (env, lp, lb, begin, end);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetub (CPXCENVptr env, CPXCLPptr lp, double *ub, CPXDIM begin, CPXDIM end) {
      return CPX_CALL (getub) (env, lp, ub, begin, end);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetrngval (CPXCENVptr env, CPXCLPptr lp, double *rngval, CPXDIM begin, CPXDIM end) {
      return CPX_CALL (getrngval) (env, lp, rngval, begin, end);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetprobname (CPXCENVptr env, CPXCLPptr lp, char *buf_str, CPXSIZE bufspace, CPXSIZE *surplus_p) {
      return CPX_CALL (getprobname) (env, lp, buf_str, bufspace, surplus_p);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetobjname (CPXCENVptr env, CPXCLPptr lp, char *buf_str, CPXSIZE bufspace, CPXSIZE *surplus_p) {
      return CPX_CALL (getobjname) (env, lp, buf_str, bufspace, surplus_p);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetcolname (CPXCENVptr env, CPXCLPptr lp, char **name, char *namestore, CPXSIZE storespace, CPXSIZE *surplus_p, CPXDIM begin, CPXDIM end) {
      return CPX_CALL (getcolname) (env, lp, name, namestore, storespace, surplus_p, begin, end);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetrowname (CPXCENVptr env, CPXCLPptr lp, char **name, char *namestore, CPXSIZE storespace, CPXSIZE *surplus_p, CPXDIM begin, CPXDIM end) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXwriteparam (CPXCENVptr env, const char *filename_str) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXtuneparam (CPXENVptr env, CPXLPptr lp, int intcnt, const int *intnum, const CPXINT *intval, int dblcnt, const int *dblnum, const double *dblval, int strcnt, const int *strnum, char const *const *strval, int *tunestat_p) {
      return CPX_CALL (tuneparam) (env, lp, intcnt, intnum, intval, dblcnt, dblnum, dblval, strcnt, strnum, strval, tunestat_p);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXtuneparamprobset (CPXENVptr env, int filecnt, char const *const *filename, char const *const *filetype, int intcnt, const int *intnum, const CPXINT *intval, int dblcnt, const int *dblnum, const double *dblval, int strcnt, const int *strnum, char const *const *strval, int *tunestat_p) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXmdleave (CPXCENVptr env, CPXLPptr lp, const CPXDIM *indices, CPXDIM cnt, double *downratio, double *upratio) {
      return CPX_CALL (mdleave) (env, lp, indices, cnt, downratio, upratio);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXstrongbranch (CPXCENVptr env, CPXLPptr lp, const CPXDIM *indices, CPXDIM cnt, double *downobj, double *upobj, CPXCNT itlim) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXcopypartialbase (CPXCENVptr env, CPXLPptr lp, CPXDIM rcnt, const CPXDIM *rindices, const int *rstat, CPXDIM ccnt, const CPXDIM *cindices, const int *cstat) {
      return CPX_CALL (copypartialbase) (env, lp, rcnt, rindices, rstat, ccnt, cindices, cstat);
   }
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXtightenbds (CPXCENVptr env, CPXLPptr lp, CPXDIM cnt, const CPXDIM *indices, const char *lu, const double *bd) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXuncrushform (CPXCENVptr env, CPXCLPptr lp, CPXDIM plen, const CPXDIM *pind, const double *pval, CPXDIM *len_p, double *offset_p, CPXDIM *ind, double *val) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXcopyprotected (CPXCENVptr env, CPXLPptr lp, CPXDIM cnt, const CPXDIM *indices) {
      return CPX_CALL (copyprotected) (env, lp, cnt, indices);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetprotected (CPXCENVptr env, CPXCLPptr lp, CPXDIM *cnt_p, CPXDIM *indices, CPXDIM pspace, CPXDIM *surplus_p) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXcopyorder (CPXCENVptr env, CPXLPptr lp, CPXDIM cnt, const CPXDIM *indices, const CPXDIM *priority, const int *direction) {
      return CPX_CALL (copyorder) (env, lp, cnt, indices, priority, direction);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXcopysos (CPXCENVptr env, CPXLPptr lp, CPXDIM numsos, CPXNNZ numsosnz, const char *sostype, const CPXNNZ *sosbeg, const CPXDIM *sosind, const double *soswt, char const *const *sosname) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetnumcuts (CPXCENVptr env, CPXCLPptr lp, int cuttype, CPXDIM *num_p) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetmipstartindex (CPXCENVptr env, CPXCLPptr lp, const char *lname_str, int *index_p) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXchgctype (CPXCENVptr env, CPXLPptr lp, CPXDIM cnt, const CPXDIM *indices, const char *xctype) {
      return CPX_CALL (chgctype) (env, lp, cnt, indices, xctype);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXaddsos (CPXCENVptr env, CPXLPptr lp, CPXDIM numsos, CPXNNZ numsosnz, const char *sostype, const CPXNNZ *sosbeg, const CPXDIM *sosind, const double *soswt, char const *const *sosname) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetsos (CPXCENVptr env, CPXCLPptr lp, CPXNNZ *numsosnz_p, char *sostype, CPXNNZ *sosbeg, CPXDIM *sosind, double *soswt, CPXNNZ sosspace, CPXNNZ *surplus_p, CPXDIM begin, CPXDIM end) {
      return CPX_CALL (getsos) (env, lp, numsosnz_p, sostype, sosbeg, sosind, soswt, sosspace, surplus_p, begin, end);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetsosname (CPXCENVptr env, CPXCLPptr lp, char **name, char *namestore, CPXSIZE storespace, CPXSIZE *surplus_p, CPXDIM begin, CPXDIM end) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetsosinfeas (CPXCENVptr env, CPXCLPptr lp, const double *x, double *infeasout, CPXDIM begin, CPXDIM end) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetindconstr (CPXCENVptr env, CPXCLPptr lp, CPXDIM *indvar_p, int *complemented_p, CPXDIM *nzcnt_p, double *rhs_p, char *sense_p, CPXDIM *linind, double *linval, CPXDIM space, CPXDIM *surplus_p, CPXDIM which) {
      return CPX_CALL (getindconstr) (env, lp, indvar_p, complemented_p, nzcnt_p, rhs_p, sense_p, linind, linval, space, surplus_p, which);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetindconstrindex (CPXCENVptr env, CPXCLPptr lp, const char *lname_str, CPXDIM *index_p) {
      return CPX_CALL (getindconstrindex) (env, lp, lname_str, index_p);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetindconstrname (CPXCENVptr env, CPXCLPptr lp, char *buf_str, CPXSIZE bufspace, CPXSIZE *surplus_p, CPXDIM which) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetindconstrinfeas (CPXCENVptr env, CPXCLPptr lp, const double *x, double *infeasout, CPXDIM begin, CPXDIM end) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetorder (CPXCENVptr env, CPXCLPptr lp, CPXDIM *cnt_p, CPXDIM *indices, CPXDIM *priority, int *direction, CPXDIM ordspace, CPXDIM *surplus_p) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXaddsolnpooldivfilter (CPXCENVptr env, CPXLPptr lp, double lower_bound, double upper_bound, CPXDIM nzcnt, const CPXDIM *ind, const double *weight, const double *refval, const char *lname_str) {
      return CPX_CALL (addsolnpooldivfilter) (env, lp, lower_bound, upper_bound, nzcnt, ind, weight, refval, lname_str);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXaddsolnpoolrngfilter (CPXCENVptr env, CPXLPptr lp, double lb, double ub, CPXDIM nzcnt, const CPXDIM *ind, const double *val, const char *lname_str) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetsolnpooldivfilter (CPXCENVptr env, CPXCLPptr lp, double *lower_cutoff_p, double *upper_cutoff_p, CPXDIM *nzcnt_p, CPXDIM *ind, double *val, double *refval, CPXDIM space, CPXDIM *surplus_p, int which) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetsolnpoolrngfilter (CPXCENVptr env, CPXCLPptr lp, double *lb_p, double *ub_p, CPXDIM *nzcnt_p, CPXDIM *ind, double *val, CPXDIM space, CPXDIM *surplus_p, int which) {
      return CPX_CALL (getsolnpoolrngfilter) (env, lp, lb_p, ub_p, nzcnt_p, ind, val, space, surplus_p, which);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetsolnpoolfiltername (CPXCENVptr env, CPXCLPptr lp, char *buf_str, CPXSIZE bufspace, CPXSIZE *surplus_p, int which) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetsolnpoolslack (CPXCENVptr env, CPXCLPptr lp, int soln, double *slack, CPXDIM begin, CPXDIM end) {
      return CPX_CALL (getsolnpoolslack) (env, lp, soln, slack, begin, end);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetsolnpoolqconstrslack (CPXCENVptr env, CPXCLPptr lp, int soln, double *qcslack, CPXDIM begin, CPXDIM end) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetcallbacknodeinfo (CPXCENVptr env, void *cbdata, int wherefrom, CPXCNT nodeindex, int whichinfo, void *result_p) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXbranchcallbackbranchbds (CPXCENVptr env, void *cbdata, int wherefrom, double nodeest, CPXDIM cnt, const CPXDIM *indices, const char *lu, const int *bd, void *userhandle, CPXCNT *seqnum_p) {
      return CPX_CALL (branchcallbackbranchbds) (env, cbdata, wherefrom, nodeest, cnt, indices, lu, bd, userhandle, seqnum_p);
   }
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetcallbackorder (CPXCENVptr env, void *cbdata, int wherefrom, CPXDIM *priority, int *direction, CPXDIM begin, CPXDIM end) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetcallbackgloballb (CPXCENVptr env, void *cbdata, int wherefrom, double *lb, CPXDIM begin, CPXDIM end) {
      return CPX_CALL (getcallbackgloballb) (env, cbdata, wherefrom, lb, begin, end);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetcallbackglobalub (CPXCENVptr env, void *cbdata, int wherefrom, double *ub, CPXDIM begin, CPXDIM end) {
      return CPX_CALL (getcallbackglobalub) (env, cbdata, wherefrom, ub, begin, end);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetcallbacknodelb (CPXCENVptr env, void *cbdata, int wherefrom, double *lb, CPXDIM begin, CPXDIM end) {
      return CPX_CALL (getcallbacknodelb) (env, cbdata, wherefrom, lb, begin, end);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetcallbacknodeub (CPXCENVptr env, void *cbdata, int wherefrom, double *ub, CPXDIM begin, CPXDIM end) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXaddusercuts (CPXCENVptr env, CPXLPptr lp, CPXDIM rcnt, CPXNNZ nzcnt, const double *rhs, const char *sense, const CPXNNZ *rmatbeg, const CPXDIM *rmatind, const double *rmatval, char const *const *rowname) {
      return CPX_CALL (addusercuts) (env, lp, rcnt, nzcnt, rhs, sense, rmatbeg, rmatind, rmatval, rowname);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXaddlazyconstraints (CPXCENVptr env, CPXLPptr lp, CPXDIM rcnt, CPXNNZ nzcnt, const double *rhs, const char *sense, const CPXNNZ *rmatbeg, const CPXDIM *rmatind, const double *rmatval, char const *const *rowname) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXNETaddnodes (CPXCENVptr env, CPXNETptr net, CPXDIM nnodes, const double *supply, char const *const *name) {
      return CPX_CALL (NETaddnodes) (env, net, nnodes, supply, name);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXNETaddarcs (CPXCENVptr env, CPXNETptr net, CPXDIM narcs, const CPXDIM *fromnode, const CPXDIM *tonode, const double *low, const double *up, const double *obj, char const *const *anames) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXNETchgname (CPXCENVptr env, CPXNETptr net, int key, CPXDIM vindex, const char *name_str) {
      return CPX_CALL (NETchgname) (env, net, key, vindex, name_str);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXNETchgarcname (CPXCENVptr env, CPXNETptr net, CPXDIM cnt, const CPXDIM *indices, char const *const *newname) {
      return CPX_CALL (NETchgarcname) (env, net, cnt, indices, newname);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXNETchgnodename (CPXCENVptr env, CPXNETptr net, CPXDIM cnt, const CPXDIM *indices, char const *const *newname) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXNETgetnodename (CPXCENVptr env, CPXCNETptr net, char **nnames, char *namestore, CPXSIZE namespc, CPXSIZE *surplus_p, CPXDIM begin, CPXDIM end) {
      return CPX_CALL (NETgetnodename) (env, net, nnames, namestore, namespc, surplus_p, begin, end);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXNETgetarcname (CPXCENVptr env, CPXCNETptr net, char **nnames, char *namestore, CPXSIZE namespc, CPXSIZE *surplus_p, CPXDIM begin, CPXDIM end) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetqpcoef (CPXCENVptr env, CPXCLPptr lp, CPXDIM rownum, CPXDIM colnum, double *coef_p) {
      return CPX_CALL (getqpcoef) (env, lp, rownum, colnum, coef_p);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetquad (CPXCENVptr env, CPXCLPptr lp, CPXNNZ *nzcnt_p, CPXNNZ *qmatbeg, CPXDIM *qmatind, double *qmatval, CPXNNZ qmatspace, CPXNNZ *surplus_p, CPXDIM begin, CPXDIM end) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXaddqconstr (CPXCENVptr env, CPXLPptr lp, CPXDIM linnzcnt, CPXNNZ quadnzcnt, double rhs, int sense, const CPXDIM *linind, const double *linval, const CPXDIM *quadrow, const CPXDIM *quadcol, const double *quadval, const char *lname_str) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetqconstr (CPXCENVptr env, CPXCLPptr lp, CPXDIM *linnzcnt_p, CPXNNZ *quadnzcnt_p, double *rhs_p, char *sense_p, CPXDIM *linind, double *linval, CPXDIM linspace, CPXDIM *linsurplus_p, CPXDIM *quadrow, CPXDIM *quadcol, double *quadval, CPXNNZ quadspace, CPXNNZ *quadsurplus_p, CPXDIM which) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetqconstrname (CPXCENVptr env, CPXCLPptr lp, char *buf_str, CPXSIZE bufspace, CPXSIZE *surplus_p, CPXDIM which) {
...
CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetqconstrinfeas (CPXCENVptr env, CPXCLPptr lp, const double *x, double *infeasout, CPXDIM begin, CPXDIM end) {
      return CPX_CALL (getqconstrinfeas) (env, lp, x, infeasout, begin, end);
   }

CPX_STATIC_INLINE int CPXPUBLIC
   CPXXgetxqxax (CPXCENVptr env, CPXCLPptr lp, double *xqxax, CPXDIM begin, CPXDIM end) {
