...
CPXLIBAPI
CPXLPptr CPXPUBLIC
   CPXScreateprob (CPXCENVptr env, int *status_p, const char *probname_str);
...
CPXLIBAPI
int CPXPUBLIC
   CPXScopylpwnames (CPXCENVptr env, CPXLPptr lp, CPXINT numcols, CPXINT numrows, int objsense, const double *objective, const double *rhs, const char *sense, const CPXINT *matbeg, const CPXINT *matcnt, const CPXINT *matind, const double *matval, const double *lb, const double *ub, const double *rngval, char const *const *colname, char const *const *rowname);

CPXLIBAPI
int CPXPUBLIC
   CPXScopylp (CPXCENVptr env, CPXLPptr lp, CPXINT numcols, CPXINT numrows, int objsense, const double *objective, const double *rhs, const char *sense, const CPXINT *matbeg, const CPXINT *matcnt, const CPXINT *matind, const double *matval, const double *lb, const double *ub, const double *rngval);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSpivot (CPXCENVptr env, CPXLPptr lp, int jenter, int jleave, int leavestat);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetx (CPXCENVptr env, CPXCLPptr lp, double *x, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetax (CPXCENVptr env, CPXCLPptr lp, double *x, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetpi (CPXCENVptr env, CPXCLPptr lp, double *pi, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetslack (CPXCENVptr env, CPXCLPptr lp, double *slack, CPXINT begin, CPXINT end);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetcolinfeas (CPXCENVptr env, CPXCLPptr lp, const double *x, double *infeasout, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetdj (CPXCENVptr env, CPXCLPptr lp, double *dj, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetgrad (CPXCENVptr env, CPXCLPptr lp, CPXINT j, CPXINT *head, double *y);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetconflict (CPXCENVptr env, CPXCLPptr lp, int *confstat_p, CPXINT *rowind, int *rowbdstat, CPXINT *confnumrows_p, CPXINT *colind, int *colbdstat, CPXINT *confnumcols_p);

CPXLIBAPI
int CPXPUBLIC
   CPXSrefineconflictext (CPXCENVptr env, CPXLPptr lp, CPXINT grpcnt, CPXINT concnt, const double *grppref, const CPXINT *grpbeg, const CPXINT *grpind, const char *grptype);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSfeasoptext (CPXCENVptr env, CPXLPptr lp, CPXINT grpcnt, CPXINT concnt, const double *grppref, const CPXINT *grpbeg, const CPXINT *grpind, const char *grptype);

CPXLIBAPI
int CPXPUBLIC
   CPXSnewrows (CPXCENVptr env, CPXLPptr lp, CPXINT rcnt, const double *rhs, const char *sense, const double *rngval, char const *const *rowname);

CPXLIBAPI
int CPXPUBLIC
   CPXSaddrows (CPXCENVptr env, CPXLPptr lp, CPXINT ccnt, CPXINT rcnt, CPXINT nzcnt, const double *rhs, const char *sense, const CPXINT *rmatbeg, const CPXINT *rmatind, const double *rmatval, char const *const *colname, char const *const *rowname);

CPXLIBAPI
int CPXPUBLIC
   CPXSnewcols (CPXCENVptr env, CPXLPptr lp, CPXINT ccnt, const double *obj, const double *lb, const double *ub, const char *xctype, char const *const *colname);

CPXLIBAPI
int CPXPUBLIC
   CPXSaddcols (CPXCENVptr env, CPXLPptr lp, CPXINT ccnt, CPXINT nzcnt, const double *obj, const CPXINT *cmatbeg, const CPXINT *cmatind, const double *cmatval, const double *lb, const double *ub, char const *const *colname);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSchgname (CPXCENVptr env, CPXLPptr lp, int key, CPXINT ij, const char *newname_str);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSchgbds (CPXCENVptr env, CPXLPptr lp, CPXINT cnt, const CPXINT *indices, const char *lu, const double *bd);

CPXLIBAPI
int CPXPUBLIC
   CPXSchgobj (CPXCENVptr env, CPXLPptr lp, CPXINT cnt, const CPXINT *indices, const double *values);

CPXLIBAPI
int CPXPUBLIC
   CPXSchgrhs (CPXCENVptr env, CPXLPptr lp, CPXINT cnt, const CPXINT *indices, const double *values);

CPXLIBAPI
int CPXPUBLIC
   CPXSchgrngval (CPXCENVptr env, CPXLPptr lp, CPXINT cnt, const CPXINT *indices, const double *values);

CPXLIBAPI
int CPXPUBLIC
   CPXSchgsense (CPXCENVptr env, CPXLPptr lp, CPXINT cnt, const CPXINT *indices, const char *sense);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSpreaddrows (CPXCENVptr env, CPXLPptr lp, CPXINT rcnt, CPXINT nzcnt, const double *rhs, const char *sense, const CPXINT *rmatbeg, const CPXINT *rmatind, const double *rmatval, char const *const *rowname);

CPXLIBAPI
int CPXPUBLIC
   CPXSprechgobj (CPXCENVptr env, CPXLPptr lp, CPXINT cnt, const CPXINT *indices, const double *values);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetobj (CPXCENVptr env, CPXCLPptr lp, double *obj, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetrhs (CPXCENVptr env, CPXCLPptr lp, double *rhs, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetsense (CPXCENVptr env, CPXCLPptr lp, char *sense, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetcols (CPXCENVptr env, CPXCLPptr lp, CPXINT *nzcnt_p, CPXINT *cmatbeg, CPXINT *cmatind, double *cmatval, CPXINT cmatspace, CPXINT *surplus_p, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetrows (CPXCENVptr env, CPXCLPptr lp, CPXINT *nzcnt_p, CPXINT *rmatbeg, CPXINT *rmatind, double *rmatval, CPXINT rmatspace, CPXINT *surplus_p, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetlb (CPXCENVptr env, CPXCLPptr lp, double *lb, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetub (CPXCENVptr env, CPXCLPptr lp, double *ub, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetrngval (CPXCENVptr env, CPXCLPptr lp, double *rngval, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetprobname (CPXCENVptr env, CPXCLPptr lp, char *buf_str, CPXSIZE bufspace, CPXSIZE *surplus_p);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetobjname (CPXCENVptr env, CPXCLPptr lp, char *buf_str, CPXSIZE bufspace, CPXSIZE *surplus_p);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetcolname (CPXCENVptr env, CPXCLPptr lp, char **name, char *namestore, CPXSIZE storespace, CPXSIZE *surplus_p, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetrowname (CPXCENVptr env, CPXCLPptr lp, char **name, char *namestore, CPXSIZE storespace, CPXSIZE *surplus_p, CPXINT begin, CPXINT end);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSwriteparam (CPXCENVptr env, const char *filename_str);
...
CPXLIBAPI
int CPXPUBLIC
   CPXStuneparam (CPXENVptr env, CPXLPptr lp, int intcnt, const int *intnum, const CPXINT *intval, int dblcnt, const int *dblnum, const double *dblval, int strcnt, const int *strnum, char const *const *strval, int *tunestat_p);

CPXLIBAPI
int CPXPUBLIC
   CPXStuneparamprobset (CPXENVptr env, int filecnt, char const *const *filename, char const *const *filetype, int intcnt, const int *intnum, const CPXINT *intval, int dblcnt, const int *dblnum, const double *dblval, int strcnt, const int *strnum, char const *const *strval, int *tunestat_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSmdleave (CPXCENVptr env, CPXLPptr lp, const CPXINT *indices, CPXINT cnt, double *downratio, double *upratio);

CPXLIBAPI
int CPXPUBLIC
   CPXSstrongbranch (CPXCENVptr env, CPXLPptr lp, const CPXINT *indices, CPXINT cnt, double *downobj, double *upobj, CPXLONG itlim);
...
CPXLIBAPI
int CPXPUBLIC
   CPXScopypartialbase (CPXCENVptr env, CPXLPptr lp, CPXINT rcnt, const CPXINT *rindices, const int *rstat, CPXINT ccnt, const CPXINT *cindices, const int *cstat);
...
CPXLIBAPI
int CPXPUBLIC
   CPXStightenbds (CPXCENVptr env, CPXLPptr lp, CPXINT cnt, const CPXINT *indices, const char *lu, const double *bd);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSuncrushform (CPXCENVptr env, CPXCLPptr lp, CPXINT plen, const CPXINT *pind, const double *pval, CPXINT *len_p, double *offset_p, CPXINT *ind, double *val);
...
CPXLIBAPI
int CPXPUBLIC
   CPXScopyprotected (CPXCENVptr env, CPXLPptr lp, CPXINT cnt, const CPXINT *indices);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetprotected (CPXCENVptr env, CPXCLPptr lp, CPXINT *cnt_p, CPXINT *indices, CPXINT pspace, CPXINT *surplus_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXScopyorder (CPXCENVptr env, CPXLPptr lp, CPXINT cnt, const CPXINT *indices, const CPXINT *priority, const int *direction);

CPXLIBAPI
int CPXPUBLIC
   CPXScopysos (CPXCENVptr env, CPXLPptr lp, CPXINT numsos, CPXINT numsosnz, const char *sostype, const CPXINT *sosbeg, const CPXINT *sosind, const double *soswt, char const *const *sosname);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetnumcuts (CPXCENVptr env, CPXCLPptr lp, int cuttype, CPXINT *num_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetmipstartindex (CPXCENVptr env, CPXCLPptr lp, const char *lname_str, int *index_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSchgctype (CPXCENVptr env, CPXLPptr lp, CPXINT cnt, const CPXINT *indices, const char *xctype);

CPXLIBAPI
int CPXPUBLIC
   CPXSaddsos (CPXCENVptr env, CPXLPptr lp, CPXINT numsos, CPXINT numsosnz, const char *sostype, const CPXINT *sosbeg, const CPXINT *sosind, const double *soswt, char const *const *sosname);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetsos (CPXCENVptr env, CPXCLPptr lp, CPXINT *numsosnz_p, char *sostype, CPXINT *sosbeg, CPXINT *sosind, double *soswt, CPXINT sosspace, CPXINT *surplus_p, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetsosname (CPXCENVptr env, CPXCLPptr lp, char **name, char *namestore, CPXSIZE storespace, CPXSIZE *surplus_p, CPXINT begin, CPXINT end);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetsosinfeas (CPXCENVptr env, CPXCLPptr lp, const double *x, double *infeasout, CPXINT begin, CPXINT end);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetindconstr (CPXCENVptr env, CPXCLPptr lp, CPXINT *indvar_p, int *complemented_p, CPXINT *nzcnt_p, double *rhs_p, char *sense_p, CPXINT *linind, double *linval, CPXINT space, CPXINT *surplus_p, CPXINT which);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetindconstrindex (CPXCENVptr env, CPXCLPptr lp, const char *lname_str, CPXINT *index_p);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetindconstrname (CPXCENVptr env, CPXCLPptr lp, char *buf_str, CPXSIZE bufspace, CPXSIZE *surplus_p, CPXINT which);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetindconstrinfeas (CPXCENVptr env, CPXCLPptr lp, const double *x, double *infeasout, CPXINT begin, CPXINT end);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetorder (CPXCENVptr env, CPXCLPptr lp, CPXINT *cnt_p, CPXINT *indices, CPXINT *priority, int *direction, CPXINT ordspace, CPXINT *surplus_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSaddsolnpooldivfilter (CPXCENVptr env, CPXLPptr lp, double lower_bound, double upper_bound, CPXINT nzcnt, const CPXINT *ind, const double *weight, const double *refval, const char *lname_str);

CPXLIBAPI
int CPXPUBLIC
   CPXSaddsolnpoolrngfilter (CPXCENVptr env, CPXLPptr lp, double lb, double ub, CPXINT nzcnt, const CPXINT *ind, const double *val, const char *lname_str);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetsolnpooldivfilter (CPXCENVptr env, CPXCLPptr lp, double *lower_cutoff_p, double *upper_cutoff_p, CPXINT *nzcnt_p, CPXINT *ind, double *val, double *refval, CPXINT space, CPXINT *surplus_p, int which);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetsolnpoolrngfilter (CPXCENVptr env, CPXCLPptr lp, double *lb_p, double *ub_p, CPXINT *nzcnt_p, CPXINT *ind, double *val, CPXINT space, CPXINT *surplus_p, int which);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetsolnpoolfiltername (CPXCENVptr env, CPXCLPptr lp, char *buf_str, CPXSIZE bufspace, CPXSIZE *surplus_p, int which);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetsolnpoolslack (CPXCENVptr env, CPXCLPptr lp, int soln, double *slack, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetsolnpoolqconstrslack (CPXCENVptr env, CPXCLPptr lp, int soln, double *qcslack, CPXINT begin, CPXINT end);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetcallbacknodeinfo (CPXCENVptr env, void *cbdata, int wherefrom, CPXLONG nodeindex, int whichinfo, void *result_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSbranchcallbackbranchbds (CPXCENVptr env, void *cbdata, int wherefrom, double nodeest, CPXINT cnt, const CPXINT *indices, const char *lu, const int *bd, void *userhandle, CPXLONG *seqnum_p);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetcallbackorder (CPXCENVptr env, void *cbdata, int wherefrom, CPXINT *priority, int *direction, CPXINT begin, CPXINT end);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetcallbackgloballb (CPXCENVptr env, void *cbdata, int wherefrom, double *lb, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetcallbackglobalub (CPXCENVptr env, void *cbdata, int wherefrom, double *ub, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetcallbacknodelb (CPXCENVptr env, void *cbdata, int wherefrom, double *lb, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetcallbacknodeub (CPXCENVptr env, void *cbdata, int wherefrom, double *ub, CPXINT begin, CPXINT end);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSaddusercuts (CPXCENVptr env, CPXLPptr lp, CPXINT rcnt, CPXINT nzcnt, const double *rhs, const char *sense, const CPXINT *rmatbeg, const CPXINT *rmatind, const double *rmatval, char const *const *rowname);

CPXLIBAPI
int CPXPUBLIC
   CPXSaddlazyconstraints (CPXCENVptr env, CPXLPptr lp, CPXINT rcnt, CPXINT nzcnt, const double *rhs, const char *sense, const CPXINT *rmatbeg, const CPXINT *rmatind, const double *rmatval, char const *const *rowname);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSNETaddnodes (CPXCENVptr env, CPXNETptr net, CPXINT nnodes, const double *supply, char const *const *name);

CPXLIBAPI
int CPXPUBLIC
   CPXSNETaddarcs (CPXCENVptr env, CPXNETptr net, CPXINT narcs, const CPXINT *fromnode, const CPXINT *tonode, const double *low, const double *up, const double *obj, char const *const *anames);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSNETchgname (CPXCENVptr env, CPXNETptr net, int key, CPXINT vindex, const char *name_str);

CPXLIBAPI
int CPXPUBLIC
   CPXSNETchgarcname (CPXCENVptr env, CPXNETptr net, CPXINT cnt, const CPXINT *indices, char const *const *newname);

CPXLIBAPI
int CPXPUBLIC
   CPXSNETchgnodename (CPXCENVptr env, CPXNETptr net, CPXINT cnt, const CPXINT *indices, char const *const *newname);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSNETgetnodename (CPXCENVptr env, CPXCNETptr net, char **nnames, char *namestore, CPXSIZE namespc, CPXSIZE *surplus_p, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXSNETgetarcname (CPXCENVptr env, CPXCNETptr net, char **nnames, char *namestore, CPXSIZE namespc, CPXSIZE *surplus_p, CPXINT begin, CPXINT end);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetqpcoef (CPXCENVptr env, CPXCLPptr lp, CPXINT rownum, CPXINT colnum, double *coef_p);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetquad (CPXCENVptr env, CPXCLPptr lp, CPXINT *nzcnt_p, CPXINT *qmatbeg, CPXINT *qmatind, double *qmatval, CPXINT qmatspace, CPXINT *surplus_p, CPXINT begin, CPXINT end);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSaddqconstr (CPXCENVptr env, CPXLPptr lp, CPXINT linnzcnt, CPXINT quadnzcnt, double rhs, int sense, const CPXINT *linind, const double *linval, const CPXINT *quadrow, const CPXINT *quadcol, const double *quadval, const char *lname_str);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetqconstr (CPXCENVptr env, CPXCLPptr lp, CPXINT *linnzcnt_p, CPXINT *quadnzcnt_p, double *rhs_p, char *sense_p, CPXINT *linind, double *linval, CPXINT linspace, CPXINT *linsurplus_p, CPXINT *quadrow, CPXINT *quadcol, double *quadval, CPXINT quadspace, CPXINT *quadsurplus_p, CPXINT which);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetqconstrname (CPXCENVptr env, CPXCLPptr lp, char *buf_str, CPXSIZE bufspace, CPXSIZE *surplus_p, CPXINT which);
...
CPXLIBAPI
int CPXPUBLIC
   CPXSgetqconstrinfeas (CPXCENVptr env, CPXCLPptr lp, const double *x, double *infeasout, CPXINT begin, CPXINT end);

CPXLIBAPI
int CPXPUBLIC
   CPXSgetxqxax (CPXCENVptr env, CPXCLPptr lp, double *xqxax, CPXINT begin, CPXINT end);
