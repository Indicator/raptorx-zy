...
#if !defined(CPXSIZE_BITS) && ( defined(__xlc__) || defined(__xlC__) )
    /* __64BIT__ works on all platforms (ppc/x86-64, AIX/LINUX) */
...
#endif /* !defined(CPXSIZE_DEFINED) */

/* CPX_BIGINT:    Used for infinite CPXINT parameter values */

#define CPX_BIGINT    2100000000

/* CPX_BIGLONG:   Used for infinite CPXLONG parameter values */
...
#      define CPXDEPRECATEDAPI __declspec(dllexport deprecated)
#      define CPXDEPRECATED __declspec(deprecated)
#   elif defined(__GNUC__) && defined(__linux__)
#      define CPXLIBAPI __attribute__ ((visibility("default")))
#      define CPXDEPRECATEDAPI __attribute__ ((visibility("default"), deprecated))
#      define CPXDEPRECATED __attribute__ ((deprecated))
#   elif defined(__SUNPRO_C)
#      define CPXLIBAPI __global
#      define CPXDEPRECATEDAPI __global
...
#      define CPXDEPRECATEDAPI __declspec(dllimport deprecated)
#      define CPXDEPRECATED __declspec(deprecated)
#   elif defined(_WIN32)
#      define CPXLIBAPI
#      define CPXDEPRECATEDAPI __declspec(deprecated)
#      define CPXDEPRECATED __declspec(deprecated)
#   elif defined(__GNUC__) && defined(__linux__)
#      define CPXLIBAPI
#      define CPXDEPRECATEDAPI __attribute__ ((deprecated))
#      define CPXDEPRECATED __attribute__ ((deprecated))
#   else
#      define CPXLIBAPI
#      define CPXDEPRECATEDAPI
...
#   elif defined(__HP_cc)
       /* HP's cc does not recognize 'static inline' */
...
#ifndef CPX_CPXCONST_H
#define CPX_CPXCONST_H
...
#define CPX_VERSION               12040000
#define CPX_VERSION_VERSION       12
#define CPX_VERSION_RELEASE       4
...
#ifdef _WIN32
#define CPX_VERSIONSTRING "@(#)Licensed Materials - Property of IBM - 5725-A06 5725-A29 5724-Y48 5724-Y49 5724-Y54 5724-Y55: \
product CPLEX, library cplex124.lib, version 12.4.0.0, date 10/31/2011, \
Copyright IBM Corporation 1988, 2011. All Rights Reserved. \
US Government Users Restricted Rights - Use, duplication or \
disclosure restricted by GSA ADP Schedule Contract with IBM Corp."
#else
#define CPX_VERSIONSTRING "@(#)Licensed Materials - Property of IBM - 5725-A06 5725-A29 5724-Y48 5724-Y49 5724-Y54 5724-Y55: \
product CPLEX, library libcplex.a, version 12.4.0.0, date 10/31/2011, \
Copyright IBM Corporation 1988, 2011. All Rights Reserved. \
US Government Users Restricted Rights - Use, duplication or \
disclosure restricted by GSA ADP Schedule Contract with IBM Corp."
#endif
