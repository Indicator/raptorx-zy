...
if (MPI_INCLUDE_PATH AND MPI_LIBRARY)
  set(MPI_FOUND TRUE)
  if(MPI_COMPILE_FLAGS AND MPI_LINK_FLAGS)
  ELSE (MPI_COMPILE_FLAGS AND MPI_LINK_FLAGS)
    set(MPI_COMPILE_FLAGS "-I${MPI_INCLUDE_PATH} -pthread")
    set(MPI_LINK_FLAGS "-pthread -L${MPI_LIBRARY} -lmpi -lopen-rte -lopen-pal -ldl -Wl,--export-dynamic -lnsl -lutil -lm -ldl")
  endif(MPI_COMPILE_FLAGS AND MPI_LINK_FLAGS)
